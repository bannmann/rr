(:~
 ...
 :)
module namespace t="com/github/bannmann/trako/xq/transform-ast.xq";
import module namespace r="com/github/bannmann/trako/xq/eliminate-recursion.xq" at "eliminate-recursion.xq";
