(:~
 ...
 :)
module namespace s="com/github/bannmann/trako/xq/ast-to-svg.xq";

import module namespace c="com/github/bannmann/trako/xq/color.xq" at "color.xq";
import module namespace style="com/github/bannmann/trako/xq/style.xq" at "style.xq";
import module namespace n="com/github/bannmann/trako/xq/normalize-ast.xq" at "normalize-ast.xq";
import module namespace b="com/github/bannmann/trako/xq/ast-to-ebnf.xq" at "ast-to-ebnf.xq";
  ...
  if (empty($todo)) then
    ...
    let $connectors-width :=
      if (empty($done)) then
        ...
        2 * $connector-width
    return
      if ($todo[1]/self::processing-instruction()[local-name() = "trako" and normalize-space(.) = "br"]) then
        s:line-break
        (
          $page-width,
          0,
  ...
  return
    ...
    case element(g:string) return
      let $pi :=
        ...
        [local-name() = "trako" and preceding-sibling::*[1] is $node]
...
declare function s:head($color as xs:string, $page-width as xs:integer?) as element()+
{
  ...
  <meta name="generator" content="Trako {$s:version}" xmlns="http://www.w3.org/1999/xhtml"/>,
...
declare function s:svg($grammar as element(g:grammar), $showEbnf as xs:boolean, $page-width as xs:integer, $color as xs:string, $spread as xs:integer, $uri as xs:string) as node()*
{
  ...
  return
  (
    $grammar/processing-instruction()[local-name() = "trako"],
    ...
    <xhtml:p>
      <xhtml:table border="0" class="signature">
        <xhtml:tr>
          ...
          <xhtml:td valign="top">
            <xhtml:nobr class="signature">... generated by <xhtml:a name="Trako" class="signature" title="{$uri}" href="{$uri}" target="_blank">Trako - Railroad Diagram Generator</xhtml:a></xhtml:nobr>
          </xhtml:td>
        </xhtml:tr>
      </xhtml:table>
    </xhtml:p>
