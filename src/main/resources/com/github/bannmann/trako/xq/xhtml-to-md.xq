module namespace m="com/github/bannmann/trako/xq/xhtml-to-md.xq";
      ...
      if (empty($node/ancestor::xhtml:body)) then
        ...
        return
          ...
          (
            "## &#xA;",
            $img,
            " <sup>generated by [Trako - Railroad Diagram Generator][TRAKO]</sup>&#xA;",
            "&#xA;",
            "[TRAKO]: https://github.com/bannmann/trako"
          )
          else
          (
            "**", string($name), ":**&#xA;&#xA;",
